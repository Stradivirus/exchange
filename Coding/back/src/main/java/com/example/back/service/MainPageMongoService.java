    ...
    public MainPageResponseDto getLatestMainPageInfo() {
        ...
        return MainPageResponseDto.builder()
                ...
                .kosdaqList(kosdaq != null ? Collections.singletonList(KosdaqDto.builder()
                        ...
                        .build()) : Collections.emptyList())
                // mental(심리지수)
                .consumerSentimentList(
                        consumerSentiment != null ? Collections.singletonList(toConsumerSentimentDto(consumerSentiment))
                                : Collections.emptyList())
                .economicSentimentList(
                        economicSentiment != null ? Collections.singletonList(toEconomicSentimentDto(economicSentiment))
                                : Collections.emptyList())
                .newsSentimentList(newsSentimentList != null && !newsSentimentList.isEmpty()
                        ? newsSentimentList.stream().map(this::toNewsSentimentDto).toList()
                        : Collections.emptyList())
                .build();
    }
